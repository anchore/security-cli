...
class RConsortium(ArchiveProvider):
    def __init__(self):
        super().__init__(
            name="RConsortium Security Advisories",
            url="https://github.com/RConsortium/r-advisory-database/archive/refs/heads/main.tar.gz",
        )
